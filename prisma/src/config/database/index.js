...
path.join(process.cwd(), "prisma/src/config/database/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/src/config/database/schema.prisma")
